...
const tabsTriggerCN = "font-site_button lg:text-sm rounded-md border border-peach px-4 py-2 transition-all duration-200 hover:border-white/30 hover:text-site_orange data-[state=active]:bg-site_navy data-[state=active]:text-site_orange data-[state=active]:border-site_orange";
