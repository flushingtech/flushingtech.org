...
export default function LeaderboardContainer() {
  ...
  return (
    <div
  ref={containerRef}
  className="invisible flex-col justify-between h-full bg-gradient-to-b from-black/85 via-black/50 to-black/10 right-0 top-0 py-4 px-2 text-peach animate-slide-in-3s mt-4 lg:mt-0 overflow-auto"
>
