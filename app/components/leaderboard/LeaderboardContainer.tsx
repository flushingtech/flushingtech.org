...
export default function LeaderboardContainer() {
  ...
  return (
    <div
      ref={containerRef}
      className="invisible h-auto lg:w-[30%] lg:max-w-[600px] lg:h-full bg-gradient-to-b from-black/85 via-black/50 to-black/10 lg:absolute right-0 top-0 py-4 px-2 text-peach animate-slide-in mt-4 lg:mt-0 overflow-auto"
    >
