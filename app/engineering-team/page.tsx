      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center gap-0 mb-10 flex-wrap">
          <button
            ...
            className={`flex items-center justify-center gap-2 px-6 py-3 rounded-l-md font-medium w-96 text-center transition-all duration-500 border-2 border-r-gray-500 ${
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 px-6 py-3 font-medium w-96 text-center transition-all duration-500 border-1 border-gray-300 border-1 border-l-gray-500 border-1 border-r-gray-500 ${
          ...
          <button
            ...
            className={`flex items-center justify-center rounded-r-md gap-2 px-6 py-3 font-medium w-96 text-center transition-all duration-500 border-2 border-l-gray-500 ${
