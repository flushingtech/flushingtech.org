...
const EventCard = ({
  ...
  <div onClick={onClick} className="cursor-pointer">
    ...
    <Card
      className={`bg-transparent border-2 rounded-none border-peach ${selected ? "md:border-accent" : "md:border-peach"
        }`}
    >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-44 gap-y-12">
            <div className="grid grid-rows-2 grid-cols-4">
              ...
              <div className="row-start-2 row-end-3 col-start-2 col-end-4 flex justify-center items-center mt-6">
                <a
                  href="https://www.meetup.com/flushing-tech/events/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-[6px] px-8 py-4 bg-white rounded-full border shadow-sm hover:scale-105 transition-transform"
                >
                  <span className="text-base md:text-lg font-semibold text-black">RSVP on</span>
                  <Image
            ...
            <iframe src="https://discord.com/widget?id=1121935362663657503&theme=dark"
              width="350"
              height="500"
